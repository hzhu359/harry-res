...
\definecolor{awesome}{HTML}{4b2c70} % Uncomment if you would like to specify your own color

% Colors for text - uncomment and modify
%\definecolor{darktext}{HTML}{414141}
% \definecolor{text}{HTML}{414141}
%\definecolor{graytext}{HTML}{414141}
% \definecolor{lighttext}{HTML}{232323}
...
\address{Atlanta, GA}
% \mobile{(317) 919-9018}
\email{namename@gatech.edu}
\homepage{namename.github.io}
\github{namename}
\linkedin{namename}
%\skype{skypeid}
...
% \makecvfooter{Harrison Zhu}{Résumé}{\the\year} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
